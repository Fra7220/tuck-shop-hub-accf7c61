...
const EmployeeSessions = () => {
  ...
  const renderActiveSessionCard = () => {
    ...
    // Last remaining participant can control the session even if not the creator
    const canControlSession = isSessionCreator || (isParticipating && activeParticipantCount === 1);
                    ...
                    <div className="border-t pt-4">
                      {!isSessionCreator && (
                        <p className="text-xs text-amber-600 dark:text-amber-400 font-medium mb-2 flex items-center gap-1">
                          ...
                          You are the last active participant — you can now submit and close this session.
                        </p>
                      )}
