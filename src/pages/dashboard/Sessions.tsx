...
const Sessions = () => {
  const { user, tuckshopId, role } = useAuth();
  ...
  // Last remaining participant can control the session even if they didn't start it
  const canControlSession = isParticipating;
                      ...
                      return (
                        <div key={s.id} className="rounded-xl border bg-card p-4 space-y-3">
                          ...
                          <div className="text-xs">
                            ...
                            <span className="font-semibold text-primary">{profilesMap[s.employee_id] || "Unknown"}</span>
                          </div>
                        ...
                        <Table className="premium-table w-full">
                          <TableHeader className="bg-muted/50">
                            <TableRow>
                              ...
                              {isAdmin && <TableHead className="text-right font-bold w-12">Actions</TableHead>}
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {sessions.map((s) => (
                              <TableRow key={s.id}>
                                ...
                                <TableCell className="font-semibold text-primary">{profilesMap[s.employee_id] || "Unknown"}</TableCell>
                                <TableCell>
                                  {s.participants && s.participants.length > 0 ? (
